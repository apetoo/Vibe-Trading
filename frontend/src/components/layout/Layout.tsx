...
import { Activity, BarChart3, Bot, FileText, Languages, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Network, Loader2 } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/industry-chain", icon: Network, label: t('layout.industryChain') },
